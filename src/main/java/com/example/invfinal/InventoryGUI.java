...
public class InventoryGUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Button to switch to manager view
        Button managerViewButton = new Button("Manager View");
        managerViewButton.setOnAction(e -> startManagerView(new Stage(), "Alice"));

        // Button to switch to customer view
        Button customerViewButton = new Button("Customer View (Bob)");
        customerViewButton.setOnAction(e -> startCustomerView(new Stage(), "Bob"));

        mainLayout.getChildren().addAll(managerViewButton, customerViewButton);
