...
public class InventoryManagementSystem extends Application {
    ...
    private List<Order> currentCart = new ArrayList<>();
    ...
    public void start(Stage primaryStage) {
        ...
        // Show the login interface at the start
    ...
    // Customer Interface, Statistics Interface, and other methods remain unchanged
    private void showCustomerInterface(Stage stage) { BorderPane customerRoot = new BorderPane();
    ...
    private void showStatisticsInterface(Stage stage) { BorderPane statisticsRoot = new BorderPane();
    ...
    private void updateTotalProducts() { totalProductsLabel.setText("Total Products: " + inventory.size()); }
